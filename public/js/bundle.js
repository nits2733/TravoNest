...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1Ijoibml0czI3MzMiLCJhIjoiY203ZXQ5aTU5MGJmZTJrc2N3bjNtejEzZSJ9.GhIKTA0shljcsdakj9cXiQ';

  // Initialize the map
  var map = new mapboxgl.Map({
    container: 'map',
    // ID of the map container in HTML
    style: 'mapbox://styles/nits2733/cm7f017u000hi01r75dgg6to2',
    // Custom map style
  ...
  locations.forEach(function (loc) {
    ...
    .setHTML("<p>".concat(loc.day, ": ").concat(loc.description, "</p>")) // Display description
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51R3GdVFNTJAheHpo6dava9BW18nzLz3pRfUTczVH2jURvtg09fnMBXd2AVL5UdqVjgTIJE1SO0KnfwVmjSGpwKi5000JEMZAaT');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alerts.showAlert)('error', 'An error occurred while trying to book the tour.');
        case 13:
        case "end":
          return _context.stop();
      }
...
// Event listeners for mapbox
},{"./mapbox.js":"mapbox.js","./login.js":"login.js","./signup.js":"signup.js","./updateSettings.js":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
